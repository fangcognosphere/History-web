    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 pt-12 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="mb-4 text-sm leading-relaxed">
              Trang thông tin lịch sử Việt Nam chính thống, cung cấp kiến thức từ nguồn đáng tin cậy, 
              giúp bạn hiểu sâu sắc hơn về dân tộc và đất nước.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-white transition-colors">Thời Kỳ Đồ Đá</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Văn Lang - Âu Lạc</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Thời Kỳ Bắc Thuộc</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Thời Kỳ Độc Lập</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Thời Kỳ Đại Việt</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Thời Kỳ Cận - Hiện Đại</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Di Sản Văn Hóa</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>info@lichsuvietnam.vn</span>
              </li>
              <li className="flex items-center space-x-3">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} Lịch Sử Việt Nam. Tất cả các quyền được bảo lưu.</p>
