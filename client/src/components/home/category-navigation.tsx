  ...
  const categories: Category[] = [
    {
      ...
      imageUrl: "https://files.catbox.moe/j0rjgj.jpg",
      color:
        "bg-primary-100 dark:bg-primary-800 text-primary-700 dark:text-primary-300",
      link: "/category/NhanVat",
      description:
        "Khám phá những nhân vật đã làm nên lịch sử dân tộc Việt Nam qua các thời kỳ",
    },
    {
      id: "su-kien",
      name: "Sự Kiện Lịch Sử",
      imageUrl: "https://files.catbox.moe/331b2h.jpg",
      color:
        "bg-secondary-100 dark:bg-secondary-800 text-secondary-700 dark:text-secondary-300",
      link: "/category/SuKien",
      description:
        "Tìm hiểu về các sự kiện quan trọng đã định hình nên lịch sử Việt Nam",
    },
    {
      id: "trieu-dai",
      name: "Thời Kỳ Lịch Sử",
      imageUrl: "https://files.catbox.moe/mccszg.jpg",
